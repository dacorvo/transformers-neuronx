...
def export_neuron_model(model_id, batch_size, tp_degree, amp, save_dir):
    ...
    model_neuron = LlamaForSampling.from_pretrained(chkpt_dir,
...
if __name__ == "__main__":
    ...
    parser.add_argument("model", type=str, default="openlm-research/open_llama_3b",
                        help="The HF Hub model id or a local directory")
    parser.add_argument("--batch_size", type=int, default=1)
    parser.add_argument("--seq_length", type=int, default=1024)
    parser.add_argument("--tp_degree", type=int, default=1)
    parser.add_argument("--amp", type=str, default="f16", help="One of f32, f16, bf16")
